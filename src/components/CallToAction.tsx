    ...
    <div className="bg-black text-white py-[72px] sm:py-24" ref={containerRef}>
      <div className="container max-w-xl relative">
        ...
        <p className="text-xl text-white/70  mt-5">
          Click the button below to sign up and experience crmtooling.com for
          yourself. Boost your efficiency and get instant access to a smarter
          way of managing customer relationships.
        </p>
