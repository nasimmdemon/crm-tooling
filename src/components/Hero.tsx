      ...
      <div className="container relative">
        ...
        <div className="flex justify-center">
          <p className="text-xl text-center mt-8 max-w-md">
            crmtooling.com is a powerful CRM solution designed to simplify and
            streamline customer management. From storing customer details to
            tracking communications, crmtooling.com gives you the tools to
            maintain strong relationships and manage customer interactions
            seamlessly.
          </p>
        </div>
        <div className="flex justify-center mt-8">
